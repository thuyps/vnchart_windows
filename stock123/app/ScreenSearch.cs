...
{
    public class ScreenSearch: ScreenBase
    {
...
//            IComparer<Share>
        ...
        public void createRightPanel()
        {
            ...
            if (mContext.mIsViewSplitted)
            {
                ...
                for (int i = 0; i < 2; i++)
                {
                    HistoryChartControl his = new HistoryChartControl("panel" + (i+1), ws[i], mRightPanel.getH(), i==1);
            ...
            {
                HistoryChartControl his = new HistoryChartControl("pannel0", w, mRightPanel.getH(), false);
                his.setListener(this);
                his.setPosition(0, 0);
