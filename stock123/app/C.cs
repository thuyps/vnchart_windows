...
namespace stock123.app
{
    public class C
    {
        public const int CLIENT_VERSION = 0x00000207;

        public const int DATE_BEGIN = (2000 << 16) | (1 << 8) | 1;
        ...
        //public const string URL_SERVER = "http://soft123.com.vn:8084/SmaSrv/SSTK";
        ...
        public const int ID_CHART_RANGE_END = 1200;
        ...
        public const int _SORT_RSI_OVERSOLD = (1 << 7);
        public const int _SORT_MFI_OVERSOLD = (1 << 8);
        public const int _SORT_ROC_OVERSOLD = (1 << 9);
        ...
        public const int x = (1 << 13);
        public const int y = (1 << 14);
        public const int z = (1 << 15);
        public const int a = (1 << 16);
        public const int s = (1 << 17);
        public const int d = (1 << 18);
        public const int f = (1 << 19);
        public const int g = (1 << 20);
        ...
        public const int ID_TS_ADD_SUBCHART = 1450;

        public const int ID_BUTTON_QUOTE = 1451;

        public const int ID_EDIT_BOLLINGER = 1460;
        public const int ID_EDIT_ICHIMOKU = 1461;
        public const int ID_EDIT_PSAR = 1462;
        public const int ID_EDIT_ZIGZAG = 1463;
